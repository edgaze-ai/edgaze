...
```css
--onboarding-bg: #0a0a0b --onboarding-surface: #111113
  --onboarding-border: rgba(255, 255, 255, 0.06) --onboarding-teal: #00e5cc
...
--font-instrument-serif:
  "Instrument Serif", serif --font-dm-sans: "DM Sans",
  sans-serif --font-jetbrains-mono: "JetBrains Mono", monospace;
```
