...
const QUERY_SYNONYMS: Record<string, string[]> = {
  ...
  picture: ["image", "picture", "photo", "llm-image", "openai-image"],
  photo: ["image", "picture", "photo", "llm-image", "openai-image"],
  api: ["http", "request", "fetch", "url", "call", "endpoint"],
  request: ["http", "request", "fetch", "api"],
  fetch: ["http", "request", "fetch"],
  youtube: ["youtube", "transcript", "captions", "video"],
  transcript: ["transcript", "captions", "subtitles", "youtube"],
  captions: ["captions", "transcript", "subtitles", "youtube"],
  ...
  gpt: ["openai", "chat", "gpt", "llm-chat", "openai-chat"],
  claude: ["claude", "anthropic", "sonnet", "haiku", "llm-chat"],
  gemini: ["gemini", "google", "flash", "llm-chat"],
  ai: ["openai", "chat", "embedding", "image", "ai", "claude", "gemini"],
  embed: ["embedding", "embed", "vector", "llm-embeddings", "openai-embeddings"],
  vector: ["embedding", "vector", "llm-embeddings", "openai-embeddings"],
};
