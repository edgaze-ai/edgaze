      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-white/80">
          ...
          <section>
            ...
            <p>
              At Edgaze, we want you to be satisfied with your purchases. This Refund Policy
              explains when and how you can request a refund for workflows and prompts purchased on
              our platform.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                You lack the technical knowledge to use the product (unless it was misrepresented as
                beginner-friendly)
              </li>
          ...
          <section>
            ...
            <p className="mt-4">We aim to respond to all refund requests within 2 business days.</p>
          </section>
          ...
          <section>
            ...
            <p>In some cases, we may offer a partial refund:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Chargebacks should be a last resort. If you file a chargeback without contacting us
              first:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="mt-4">Excessive refund rates may result in creator account review.</p>
          </section>
