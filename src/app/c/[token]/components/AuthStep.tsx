...
export default function AuthStep({ creatorName, creatorPhotoUrl, inviteToken, onSuccess }: AuthStepProps) {
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        // Claim the invite
        const claimResponse = await fetch(`/api/invite-token/${encodeURIComponent(inviteToken)}/claim`, {
          method: 'POST',
        });
