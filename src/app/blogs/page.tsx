...
export default function BlogsHomePage() {
  ...
  const renderBlogCard = (blog: (typeof blogs)[number], key: string, href: string) => (
  ...
  return (
    <div className="w-full">
      ...
      <section className="space-y-8 sm:space-y-10">
        {firstBlog
          ? renderBlogCard(firstBlog, "blog-card-1", "/blogs/ai-prompts-no-distribution")
          : null}
        {secondBlog ? renderBlogCard(secondBlog, "blog-card-2", "/blogs/introducing-blogs") : null}
      </section>
