      ...
      <div className="relative text-white">
        ...
        >
          ...
          <Section
            id="platform"
            wide
            eyebrow="Explore Edgaze"
            title="Understand the platform with direct paths to every major section."
            desc="Browse the public sections Google should understand clearly: marketplace discovery, builder tools, prompt creation, templates, docs, creator programs, pricing, and company pages."
          >
              ...
              {[
                {
                  href: "/marketplace",
                  title: "Marketplace",
                  text: "Discover AI workflows, prompts, and creator storefronts.",
                },
                {
                  href: "/builder",
                  title: "Workflow Builder",
                  text: "Build and publish multi-step AI workflows.",
                },
                {
                  href: "/prompt-studio",
                  title: "Prompt Studio",
                  text: "Create reusable AI prompts with structured inputs.",
                },
                {
                  href: "/templates",
                  title: "Templates",
                  text: "Start from proven workflow structures instead of a blank canvas.",
                },
                {
                  href: "/docs",
                  title: "Documentation",
                  text: "Learn the product, platform policies, and builder workflows.",
                },
                {
                  href: "/creators",
                  title: "Creators",
                  text: "See how creators publish and monetize workflow products.",
                },
                {
                  href: "/pricing",
                  title: "Pricing",
                  text: "Compare plans, hosted run limits, and marketplace fees.",
                },
                {
                  href: "/about",
                  title: "About",
                  text: "Learn what Edgaze is building and why it exists.",
                },
                {
                  href: "/contact",
                  title: "Contact",
                  text: "Reach the team for support, press, or partnerships.",
                },
              ].map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="rounded-3xl bg-white/4 p-6 ring-1 ring-white/10 transition-colors hover:bg-white/6"
                >
                  <div className="text-lg font-semibold text-white">{link.title}</div>
                  <p className="mt-2 text-sm leading-6 text-white/65">{link.text}</p>
                </a>
              ))}
            </div>
          </Section>
