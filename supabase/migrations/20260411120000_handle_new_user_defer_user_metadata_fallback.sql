-- GoTrue merges user_metadata into raw_user_meta_data reliably on insert; app_metadata timing can lag.
-- Honor defer from either bucket so admin provisioning never double-inserts profiles.
